...
import {
    ...
    CreditCard, Banknote, Landmark, Gift, TrendingUp, Smartphone
} from 'lucide-react';
...
export function Donations() {
    ...
    const transactions = [
        ...
        { id: 6, donor: "Suresh Raina", amount: "₹7,500", method: "UPI", date: "01 Feb 2024", category: "General Fund", status: "Success", color: "#6366f1" },
        { id: 7, donor: "Anitha P.", amount: "₹2,000", method: "Card", date: "31 Jan 2024", category: "Annathanam", status: "Success", color: "#ec4899" },
    ];
    ...
    return (
        <div className="donations-page" style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0, gap: '1rem' }}>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            ...
                            <tbody>
                                {currentTransactions.map((tx, idx) => (
                                    <tr key={tx.id} style={{
                                        borderBottom: idx === currentTransactions.length - 1 ? 'none' : '1.5px solid #f8fafc',
                                        transition: 'all 0.2s'
                                    }} className="tx-row">
