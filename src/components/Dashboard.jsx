...
export function Dashboard() {
    ...
    return (
        <div className="dashboard-page" style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            ...
            <div style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.5rem' }}>
                        ...
                        <h1 style={{ fontSize: '1.4rem', fontWeight: 800, fontFamily: 'Lora, serif' }}>Temple Walk Console</h1>
                    </div>
                ...
                <div style={{ display: 'flex', gap: '1rem', position: 'relative', zIndex: 1 }}>
                    ...
                    <Link to="/events" style={{
                        ...
                        <Plus size={18} strokeWidth={3} /> Management Event
                    </Link>
                </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0.75rem' }}>
                {stats.map((stat, idx) => (
                    <div key={idx} style={{
                        ...
                        <p style={{ fontSize: '0.7rem', fontWeight: 800, color: '#94a3b8', letterSpacing: '0.05em', marginBottom: '0.2rem' }}>{stat.label}</p>
                        <h3 style={{ fontSize: '1.25rem', fontWeight: 800, color: '#1e293b' }}>{stat.value}</h3>
                    </div>
                ))}
            </div>

            {/* Bottom Section: Trends & Activity */}
            <div style={{ display: 'grid', gridTemplateColumns: '1.8fr 1fr', gap: '0.75rem', flex: 1, minHeight: 0 }}>
