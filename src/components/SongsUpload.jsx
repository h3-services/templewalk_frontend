...
export function SongsUpload() {
    ...
    const [songs, setSongs] = useState([
        ...
        { id: 4, name: 'Traditional South Indian Nadaswaram.mp3', size: '8.5 MB', duration: '12:00', category: 'Instrumental', plays: '1.5k' },
        { id: 5, name: 'Sri Venkateswara Suprabhatam.mp3', size: '6.8 MB', duration: '09:30', category: 'Chants', plays: '3.2k' },
        { id: 6, name: 'Om Namah Shivaya Japa.wav', size: '15.2 MB', duration: '20:15', category: 'Mantra', plays: '5.4k' },
        { id: 7, name: 'Ganesha Pancharatnam.mp3', size: '3.9 MB', duration: '04:50', category: 'Bhajans', plays: '2.3k' },
    ]);
    ...
    return (
        <div className="medias-page" style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0, gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', minHeight: 0 }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ flex: 1, overflowY: 'auto' }}>
                            ...
                            {currentSongs.map((song, i) => (
                                <div key={song.id} style={{
                                    ...
                                    padding: '1rem 1.5rem',
                                    borderBottom: i === currentSongs.length - 1 ? 'none' : '1.5px solid #f8fafc',
                                    alignItems: 'center',
                                    transition: 'all 0.2s'
                                }} className="song-row">
                        ...
                        <Pagination
                            ...
                            totalEntries={filteredSongs.length}
